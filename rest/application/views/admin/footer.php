    ...
    <footer class="page-footer footer footer-static footer-dark gradient-45deg-purple-deep-orange gradient-shadow navbar-border navbar-shadow">
      <div class="footer-copyright">
        <div class="container"><span>&copy; 2019          <a href="" target="_blank">FoodFund</a> All rights reserved.</span><span class="right hide-on-small-only">Design and Developed by <a href="">FoodFund</a></span></div>
      </div>
    </footer>

    <script src="assets/admin/assets/js/vendors.min.js" type="text/javascript"></script>
    <script src="assets/admin/assets/vendors/chartjs/chart.min.js" type="text/javascript"></script>
    <script src="assets/admin/assets/vendors/chartist-js/chartist.min.js" type="text/javascript"></script>
    <!-- <script src="assets/admin/assets/vendors/chartist-js/chartist-plugin-tooltip.js" type="text/javascript"></script> -->
    <script src="assets/admin/assets/vendors/chartist-js/chartist-plugin-fill-donut.min.js" type="text/javascript"></script>
    ...
    <script src="assets/admin/assets/js/scripts/customizer.js" type="text/javascript"></script>
    <script src="assets/admin/assets/js/scripts/dashboard-modern.js" type="text/javascript"></script>
    <script src="assets/admin/assets/js/scripts/intro.js" type="text/javascript"></script>
    <script src="assets/admin/assets/js/scripts/advance-ui-modals.js" type="text/javascript"></script>



    <script src="assets/admin/assets/vendors/data-tables/js/jquery.dataTables.min.js" type="text/javascript"></script>
    <script src="assets/admin/assets/vendors/data-tables/extensions/responsive/js/dataTables.responsive.min.js" type="text/javascript"></script>
    <script src="assets/admin/assets/vendors/data-tables/js/dataTables.select.min.js" type="text/javascript"></script>
    <script src="assets/admin/assets/js/scripts/data-tables.js" type="text/javascript"></script>
